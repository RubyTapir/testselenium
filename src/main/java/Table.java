...
public class Table {  //это отдельный вспомогательный класс для основного класса Tables
    ...
    public String getValueFromCell1 (int rowNumber, int columnNumber) {
        List<List<WebElement>> rowsWithColumns = getRowsWithColumns();
        WebElement cell = rowsWithColumns.get(rowNumber - 1).get(columnNumber - 1);
        return cell.getText();
    }

    public String getValueFromCell2 (int rowNumber, String columnName) {
